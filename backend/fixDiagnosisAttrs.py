        ...
        for k,v in diagnosisAttrs.items():
            ...
            if key.replace('+', '') in k:
                ...
                if not key in dfa:
                    ...
                    dfa[key]['lifeStatus']['deadPercent'] += v['lifeStatus']['deadPercent'] / 100
                    dfa[key]['lifeStatus']['alivePercent'] += v['lifeStatus']['alivePercent'] / 100
                    dfa[key]['diabetes']['no'] += v['diabetes']['no']
                    dfa[key]['diabetes']['yes'] += v['diabetes']['yes']
                    dfa[key]['diabetes']['noPercent'] += v['diabetes']['noPercent'] / 100
                    dfa[key]['diabetes']['yesPercent'] += v['diabetes']['yesPercent'] / 100
                    dfa[key]['gender']['male'] += v['gender']['male']
                    dfa[key]['gender']['female'] += v['gender']['female']
                    dfa[key]['gender']['malePercent'] += v['gender']['malePercent'] / 100
                    dfa[key]['gender']['femalePercent'] += v['gender']['femalePercent'] / 100
